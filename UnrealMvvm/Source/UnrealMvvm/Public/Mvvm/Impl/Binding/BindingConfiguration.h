...
#include "Mvvm/Impl/Binding/BindEntry.h"
...
namespace UnrealMvvm_Impl
{
    ...
    struct FResolvedViewModelEntry
    {
        ...
        friend bool operator== (const FResolvedViewModelEntry& Entry, UBaseViewModel* ViewModel)
        {
    ...
    struct FResolvedPropertyEntry
    {
        ...
        friend bool operator== (const FResolvedPropertyEntry& Entry, const FViewModelPropertyBase* Property)
        {
